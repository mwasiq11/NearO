          ...
          <div className="grid h-16 grid-cols-[1fr_auto_1fr] items-center gap-3">
            <div className="flex items-center gap-3 justify-self-start">
              ...
              <button
                ...
                className="-ml-2 flex h-10 w-10 shrink-0 items-center justify-center rounded-full text-muted-foreground transition-colors duration-150 ease-in-out hover:bg-muted/70 hover:text-foreground active:scale-95 lg:hidden"
                aria-label={isMobile ? 'Open menu' : isTabletSidebarCollapsed ? 'Expand sidebar' : 'Collapse sidebar'}
              >
                <Menu className="h-6 w-6" />
              </button>

              <span className="md:hidden truncate whitespace-nowrap text-base font-semibold tracking-tight text-foreground">
                Dashboard
              </span>

              <span className="hidden md:inline-flex lg:hidden truncate whitespace-nowrap text-base font-semibold tracking-tight text-foreground">
                Dashboard
              </span>
            </div>
            ...
            <div className="hidden md:flex items-center justify-center justify-self-center w-full">
              {isDashboardHome && (
                <DashboardModeToggle
                  ...
                  className="dashboard-tablet-toggle inline-grid w-[clamp(240px,30vw,320px)]"
                />
              )}
            </div>

            <div className="dashboard-tablet-actions flex items-center justify-end gap-2 justify-self-end">
              <button
